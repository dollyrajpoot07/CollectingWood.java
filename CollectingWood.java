// Given an integer K and an array, height[] where height[i] denotes the height of the ith 
// tree in a forest. The task is to make a cut of height X from the ground such that exactly 
// K unit wood is collected. If it is not possible, then print -1 else print X.
